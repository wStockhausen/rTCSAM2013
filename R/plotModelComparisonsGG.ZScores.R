#'
#'@title Plot comparisons of z-scores from a set of model runs
#'
#'@description Function to plot a comparison of z-scores from a set of model runs.
#'
#'@param dfr - dataframe
...
#'@export
#'
plotModelComparisonsGG.ZScores<-function(dfr,
                                         x='y',
                                         y='zscore',
                                         color=NULL,
                                         shape=NULL,
